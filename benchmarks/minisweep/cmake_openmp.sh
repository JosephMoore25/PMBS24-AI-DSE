...
if [ "$PE_ENV" = INTEL ] ; then
  ...
  CXX=armclang++
  OMP_ARGS="-fopenmp"
  OPT_ARGS="-static -march=armv8.4-a+sve -O3 -msve-vector-bits=scalable -fomit-frame-pointer -funroll-loops -finline-limit=10000000"
fi

#------------------------------------------------------------------------------

/lustre/software/aarch64/tools/cmake/3.24.2/bin/cmake \
	--log-level=VERBOSE \
